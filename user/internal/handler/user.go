...
func (u *UserInfo) Register(info *repo.User) error {
...
func (u *UserInfo) Login(info *repo.User) error {
	if !u.checkUserName(info.UserName) {
		u.l.Error(e.UserNameInvalid.Error())
		return e.UserNameInvalid
	}
...
func (u *UserInfo) UserDelete(name string) error {
